...
The goal was to simulate a **real-world IT Support / Helpdesk workflow**, including ticket creation, SLA management, and resolution.
...
- **Normal:** 8 hour response
  ![SLA Plans](screenshots/sla-plan.png)
...
4. Tickets are resolved and closed with documented responses
...
![Ticket Submission](screenshots/ticket-submission-form.png)

![Ticket Confirmation](screenshots/ticket-confirmation-page.png)

![Agent Ticket](screenshots/ticket-display.png)
